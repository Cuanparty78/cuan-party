    ...
    return SafeArea(
      child: ListView(
        ...
        children: [
          ...
          _ProfileRow('Pesan Pribadi', Icons.chat_bubble_outline_rounded, () {
            Navigator.push(context,
                MaterialPageRoute(builder: (_) => const ChatPage()));
          }),
          _ProfileRow('Cari ID Pengguna', Icons.search_rounded, () {
            Navigator.push(context,
        ...
        children: [
          ...
          for (final item in _items)
            Padding(
              padding: const EdgeInsets.only(bottom: 10),
              child: _LuxuryCard(
                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => PrivateChatPage(userName: item.name, userId: item.name == 'Nana' ? '1000002' : item.name == 'Raka' ? '1000003' : '1000004'))),
