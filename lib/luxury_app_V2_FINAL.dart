...
class _HomePageState extends State<HomePage> {
  ...
  Widget _buildPage(int index) {
    switch (index) {
      ...
      case 1:
        return const _MomentV2Page();
      case 2:
        return const _MessageV2Page();
      case 3:
        return const _MeV2Page();
      default:
        return const _RoyalHomeContent();
    }
  }
...
class WalletV2Page extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final balance = _appState.coinBalance;
        ...
        children: [
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 10),
              Expanded(child: _walletAction(Icons.swap_horiz_rounded, 'Exchange', () {})),
              const SizedBox(width: 10),
          ...
          const SizedBox(height: 9),
          ..._appState.transactions.take(8).map(
                (tx) => Container(
                  margin: const EdgeInsets.only(bottom: 8),
...
Widget _royalSubScaffold({required String title, required Widget child}) {
  return Container(
    decoration: const BoxDecoration(
      gradient: LinearGradient(
        begin: Alignment.topCenter,
...
class _StoreV2PageState extends State<StoreV2Page> {
  final tabs = const ['Frames', 'Entry', 'Chat Bubble', 'Room Lock', 'Theme'];
  int active = 0;
