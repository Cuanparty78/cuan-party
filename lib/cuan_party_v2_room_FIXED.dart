        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 14),
              const Text(
                'Mode tester: kapasitas langsung mengubah jumlah seat yang tampil.',
              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        _RoomTab(title: 'All', selected: true),
                        _RoomTab(
                          title: 'Chat',
                          selected: false,
                          onTap: () => _showMessage(context, 'Chat tab'),
                        ),
                        _RoomTab(
                          title: 'Gift',
                          selected: false,
                    ...
                    for (final message in _messages)
                      _RoomChatBubble(message.name, message.text),
                  ],
                ),
              ),
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: FilledButton(
                    ...
                    style: FilledButton.styleFrom(
                      backgroundColor: _joined ? Colors.white24 : _roomGold,
                      foregroundColor: _joined ? Colors.white : _C.brown,
...
class _RoomChatBubble extends StatelessWidget {
  final String name;
  final String text;
  const _RoomChatBubble(this.name, this.text);
