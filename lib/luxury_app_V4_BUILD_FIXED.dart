...
class _MessageUpgradePage extends StatefulWidget {
  ...
  @override
  State<_MessageUpgradePage> createState() => _MessageUpgradePageState();
}
    ...
    return _royalScaffold(
        ...
        IconButton(
          ...
          onPressed: () {
            showModalBottomSheet(
              ...
              backgroundColor: _RoyalTheme.bg,
              builder: (_) {
                return _FriendRequestsSheet(requests: requests);
              },
            );
          },
        ),
      ...
      child: ListView(
        ...
        children: [
            ...
            Row(
              children: [
                Expanded(
                  child: TextField(
                    controller: search,
                    style: const TextStyle(color: _RoyalTheme.text),
                    decoration: const InputDecoration(
                      hintText: 'Search ID',
                      hintStyle: TextStyle(color: _RoyalTheme.muted),
                    ),
                  ),
                ),
                IconButton(
          ...
          const SizedBox(height: 8),
          _msg('CICI BIGBOSS', '🤔', '16 min', 76),
          _msg('MyPakCik', '[Image]', 'Yesterday', 0),
          _msg(
            'MANAGER ID',
            'Kritik dan keluhan diperbolehkan...',
            'Thu',
            0,
          ),
          _msg('CICI', 'cek', '11-09', 0),
        ],
      ),
    );
  }
  ...
  Widget _msg(
    ...
    return ListTile(
      ...
      subtitle: Text(
        ...
        style: const TextStyle(color: _RoyalTheme.muted),
      ),
      trailing: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          ElevatedButton(
            onPressed: () => _familyDetail(
              context,
              name,
              owner,
            ),
            child: Text(owner ? 'OPEN' : 'JOIN'),
          ),
        ],
      ),
    );
    ...
    showDialog(
      ...
      builder: (_) {
        return AlertDialog(
          ...
          content: const Text(
            'Isi nama, foto, dan announcement Family.',
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Announcement Family • Weekly & Monthly Trophy',
                style: TextStyle(color: _RoyalTheme.muted),
              ),
              const SizedBox(height: 18),
              Row(
                children: [
                  ...
                  Expanded(
                    child: OutlinedButton(
                      onPressed: () => Navigator.pop(context),
                      child: Text(owner ? 'SETTING' : 'TROPHY'),
                    ),
                  ),
                ],
              ),
...
Widget _royalScaffold({required String title, List<Widget>? actions, required Widget child}) {
  return Container(
    decoration: const BoxDecoration(
      gradient: LinearGradient(
        begin: Alignment.topCenter,
...
class WalletV2Page extends StatelessWidget {
  ...
  static final GlobalAppState _appState = GlobalAppState();
