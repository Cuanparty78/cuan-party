...
class _LuxuryBackdrop extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return IgnorePointer(
      child: CustomPaint(
        painter: _SoftLuxuryMarblePainter(),
...
class _BottomNav extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return NavigationBar(
      height: 72,
      backgroundColor: const Color(0xFF2D190D),
      ...
      destinations: [
        for (final item in items)
          NavigationDestination(
            icon: Icon(item.$1, color: const Color(0xFFE8C979)),
            selectedIcon: Icon(item.$1, color: const Color(0xFF2D190D), size: 26),
            label: item.$2,
          ),
      ],
    );
